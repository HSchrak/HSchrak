...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 22 09:20:34 2023
...
def mono(image, sepia=False):
    ...
    # The function modifies the image, so it returns True
    return True
...
def transpose(image):
    ...
    image2 = [[0] * height for _ in range(width)]
